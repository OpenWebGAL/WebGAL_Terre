    ...
    <Tooltip
      content={
        ...
        >
          ...
          {file.lastModified && (
            <div style={{ color: 'var(--text-weak)', fontSize: '11px' }}>
    ...
    >
      <div
        ...
        className={`${styles.file} ${selected ? styles.fileSelected : ''} ${
          type === 'list' ? styles.list : styles.grid
        }`}
        draggable
        onDragStart={(e) => {
                    ...
                    onKeyDown={(e) => {
                      ...
                      if (
                        ...
                        !(
                          ...
                          !isAccessible ||
                          (checkHasFile(newFileName.value) && newFileName.value !== file.name)
                        )
                      ) {
