...
import AddNewSentenceLarge from "@/pages/editor/GraphicalEditor/components/AddNewSentenceLarge";
        ...
        <Droppable droppableId="droppable">
          {(provided, snapshot) => (
            ...
            >
              ...
              <AddNewSentenceLarge onChoose={(newSentence) => addOneSentence(newSentence, splitToArray(sceneText.value).length)}/>
            </div>
          )}
        </Droppable>
      </DragDropContext>
