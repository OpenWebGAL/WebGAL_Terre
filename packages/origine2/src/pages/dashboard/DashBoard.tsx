...
import { Card, Menu, MenuItem, MenuList, MenuPopover, MenuTrigger, Toolbar, ToolbarButton, TabList, Tab, TabValue, SelectTabData,SelectTabEvent } from "@fluentui/react-components";
import { LocalLanguage24Filled, LocalLanguage24Regular, Games24Filled, Games24Regular, Album24Filled, Album24Regular, bundleIcon } from "@fluentui/react-icons";
...
export default function DashBoard() {
  ...
  const GameIcon = bundleIcon(Games24Filled, Games24Regular);

  const AlbumIcon = bundleIcon(Album24Filled, Album24Regular);
    ...
    { isDashboardShow &&
      <div className={styles.dashboard_container}>
        ...
        <div className={styles.container_main}>
          <TabList selectedValue={selectedValue.value} onTabSelect={onTabSelect} vertical>
            <Tab id="Game" icon={<GameIcon />} value="game">{t("游戏")}</Tab>
            <Tab id="Template" icon={<AlbumIcon />} value="template">{t("模板")}</Tab>
          </TabList>
